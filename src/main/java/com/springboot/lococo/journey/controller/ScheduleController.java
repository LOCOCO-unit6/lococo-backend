...
import com.springboot.lococo.journey.dto.JourneySurveyRequestDto;
...
public class ScheduleController {
   ...
   public ResponseEntity<ScheduleResponseDto> createSchedule(
           @RequestBody JourneySurveyRequestDto requestDto) {
       ScheduleResponseDto responseDto = scheduleService.generateScheduleFromSurvey(requestDto.getSurveyId());
